  ...
  actions: {
    async bootstrap() {
      ...
      try {
        ...
        // Tuy nhiên, nếu interceptor fail mà không reload trang kịp, state sẽ không đồng bộ (token có, user null)
        // Dẫn đến white screen. Nên force logout luôn.
        console.error("Bootstrap failed, forcing logout.", e)
        this.logout()
      }
    },
